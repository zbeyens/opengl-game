...
void* ResourceManager::LoadResource(RES_TYPE type, const string& name)
{
...
void* ResourceManager::NewResource(ResourceBase* data, const string& name)
{
	if (!data) return NULL;
